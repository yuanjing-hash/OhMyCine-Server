...
var libraryRetirementCleanup = []libraryRetirementCleanupStep{
	...
	{"catalog_cloud_cleanup_claims", "library_id=?", "", false},
	...
	{"media_library_deletion_evidences", "library_id=?", "", false},
	{"media_library_provider_paths", "library_id=?", "", false},
	{"media_library_provider_path_batches", "library_id=?", "", false},
