...
var (
	...
	OperationAIRecognitionConfiguration     = Operation{"ai_recognition_configuration", "AI识别设置"}
	...
	OperationMediaLibraryStructureDiagnosis = Operation{"media_library_structure_diagnosis", "目录结构诊断"}
	...
	OperationMediaReorganization            = Operation{"media_reorganization", "修正识别与重新整理"}
...
func OperationForHTTPRoute(route string) Operation {
	...
	case strings.HasPrefix(route, "/media/reorganizations"):
		return OperationMediaReorganization
	...
	case strings.HasPrefix(route, "/settings/ai-recognition"):
		return OperationAIRecognitionConfiguration
