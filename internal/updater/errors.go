...
const (
	...
	CodeRollbackBlocked       = "update_rollback_blocked_catalog_format"
	CodeCompatibilityRequired = "update_catalog_compatibility_required"
	CodeFormatIncompatible    = "update_catalog_format_incompatible"
)
