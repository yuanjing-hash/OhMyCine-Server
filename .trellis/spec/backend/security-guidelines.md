...
- Legacy Player storage migration is file/key allowlisted, never overwrites newer target data, and portable-mode import copies standard data without deleting the standard profile.
