...
import { draftFromLibrary, emptyMediaLibraryDraft, isActiveLibraryStatus, payloadFromDraft, presentLibraryStatus, supportsSidecarUpload, supportsSTRM, type MediaLibraryDraft } from '@/media-libraries'
      ...
      <aside class="panel p-2">
        ...
        >
          ...
          <button type="button" class="min-w-0 flex-1 p-2 text-left" @click="selectedID = library.id">
            ...
            <div class="text-subtle mt-2 text-xs">第 {{ index + 1 }} 顺位 · {{ library.storage_name }} · {{ library.relative_root }} · {{ library.entry_count }} 条目</div>
