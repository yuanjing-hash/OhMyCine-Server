...
export function emptyMediaLibraryDraft(storageID = 0, profileID = 0): MediaLibraryDraft {
  return {
    ...
    strm_enabled: false, strm_local_root_token: '', strm_local_path: '', metadata_artifacts_enabled: true, upload_sidecars: false, cloud_empty_cleanup_enabled: false,
...
export function draftFromLibrary(library: MediaLibraryDetail, storage?: StorageSummary): MediaLibraryDraft {
  return {
    ...
    strm_enabled: library.strm_enabled, strm_local_root_token: '', strm_local_path: library.strm_local_path || '', metadata_artifacts_enabled: library.metadata_artifacts_enabled, upload_sidecars: library.upload_sidecars, cloud_empty_cleanup_enabled: library.cloud_empty_cleanup_enabled ?? false,
...
export function payloadFromDraft(draft: MediaLibraryDraft, storage: StorageSummary | undefined): MediaLibraryWritePayload {
  const payload: MediaLibraryWritePayload = {
    ...
    cloud_empty_cleanup_enabled: storage?.type === 'pan115' && Boolean(draft.cloud_empty_cleanup_enabled),
