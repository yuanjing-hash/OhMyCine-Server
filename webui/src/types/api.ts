...
export interface MediaLibraryStructureRepairItem { ordinal: number; action: 'move' | 'recycle'; kind: string; source_path: string; target_path?: string; status: 'failed' | 'blocked'; attempt_count: number; error_code: string; error_message: string; updated_at: string }
